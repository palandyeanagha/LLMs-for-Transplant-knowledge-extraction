...
OUTPUT_RESULTS_DIR = os.path.join("/content/drive/MyDrive/FINAL_FOLDER/Maitri/retrieval_results_RPYS") # Folder to save results

# Path to your uploaded metadata CSV
# Update this path to where your metadata file actually lives in Drive or Colab
METADATA_FILE_PATH = "/content/drive/MyDrive/FINAL_FOLDER/Text Extraction/metadata_new_final_v3.csv"
...
all_chunks = []
total_file_count = 0  # Initialize a single counter

if os.path.exists(INPUT_TEXT_DIR):
    # os.walk is used here for consistency; it works for both flat folders and subfolders
    for root, dirs, files in os.walk(INPUT_TEXT_DIR):
    ...
    print("="*40)
    print(f"📂 Total txt Files Processed: {total_file_count}")
